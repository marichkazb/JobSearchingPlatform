    ...
    <div class="row">
      <div class="col-md-6 custom-left-align">
        <div>
          ...
          <h5 class="mr-3">at {{company.email}}</h5>
          <h5 class="mr-3 job-enrollment-badge mr-2 mb-2">{{company.logo}}</h5>
        ...
        <div>
          <h1>Skills</h1>
          <span
          v-for="jobs in company.jobs" :key="jobs" class="custom-badge mr-2 mb-2">
          {{ jobs }}
        </span>
        </div>
      </div>
